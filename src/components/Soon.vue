...
<div class="soon">
  <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css"> -->
	<div class="soon-text">
   <center>На данный момент приложение находится в стадии разработки.<br>
   Проект является open source-ным и Вы можете наблюдать за процессом на githube :)
   <!--  -->
    <ul ontouchstart class="ug"> 
  <li class="lg">
    <div class='link dd'>
      <a class="" href='https://github.com/prazd/task' target='_blank'></a>
      <a href='https://github.com/prazd/task' target='_blank'></a>
      <a href='https://github.com/prazd/task' target='_blank'></a>
      <a href='https://github.com/prazd/task' target='_blank'></a>
